...
void Title::SetImageInfo()
{
    ...
    if(platform== Application::Platform::OS_IPHONE){
        ...
        auto filePath_iphone = FileUtils::getInstance()->fullPathForFilename("DataFile/TitleImagePath_iphone.txt");
    ...
    if(platform==Application::Platform::OS_IPAD){
        ...
        auto filePath_ipad = FileUtils::getInstance()->fullPathForFilename("DataFile/TitleImagePath_ipad.txt");
